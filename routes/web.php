...
use App\Http\Controllers\SeriesModuleController;
...
Route::get('/modules/series/data', [SeriesModuleController::class, 'getSeriesData'])->name('modules.series.data');
Route::post('/modules/series/create', [SeriesModuleController::class, 'createSeriesModule'])->name('modules.series.create');
